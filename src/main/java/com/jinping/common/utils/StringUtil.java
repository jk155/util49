...
public class StringUtil {
	...
	public static String randomChineseString(int length){
		...
		for (int i = 0; i <length; i++) {
			...
			int a=176+Math.abs(random.nextInt(39));
			int b=161+Math.abs(random.nextInt(93));
			byte aa=(byte)a;
			byte bb=(byte)b;
			byte[] use=new byte[2];
			use[0]=aa;
